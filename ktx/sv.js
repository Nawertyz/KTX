...
const studentData = {
    "2021001": { name: "Nguyễn Văn A", gender: "Nam", hometown: "Hải Phòng", contact: "0123456789", dob: "01/01/2000", class: "CNTT" },
    "2021002": { name: "Trần Thị B", gender: "Nữ", hometown: "Hải Dương", contact: "0987654321", dob: "02/02/2001", class: "CNTT" },
    "2021003": { name: "Nguyễn Văn C", gender: "Nam", hometown: "Cao Bằng", contact: "0331254669", dob: "03/03/2002", class: "CNTT" },
    "2021004": { name: "Trịnh Hồng D", gender: "Nữ", hometown: "Hà Nội", contact: "0789456123", dob: "04/04/2003", class: "CNTT" },
    "2021005": { name: "Nguyễn Văn E", gender: "Nam", hometown: "Thái Bình", contact: "01239876", dob: "05/05/2004", class: "CNTT" },
    "2021006": { name: "Nguyễn Văn F", gender: "Nam", hometown: "Quảng Ninh", contact: "0159875321", dob: "06/06/2005", class: "CNTT" },
    "2021007": { name: "Nguyễn Thị G", gender: "Nữ", hometown: "Hồ Chí Minh", contact: "0123578977", dob: "07/07/2006", class: "CNTT" },
};
let currentRow = null; 
...
function addOrUpdateStudent() {
    ...
    if (!student) {
        ...
        if (!nameRegex.test(hometown)) { 
            alert("Quê quán chỉ được nhập chữ cái!");
            return;
        }
...
function editStudent(row) {
    ...
    spInput.value = cells[6].textContent; 
    ...
    cells[6].textContent = spInput.value; 
